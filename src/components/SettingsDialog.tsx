      ...
      <div className="bg-gray-800 rounded-lg shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto" onClick={e => e.stopPropagation()}>
        <div className="p-6">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between mb-4">
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-3 py-1.5 text-sm font-medium text-white bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-blue-500"
                >
                ...
                <div className="p-3 mb-4 space-y-3 rounded-lg bg-gray-700/50">
                  ...
                  <div className="flex justify-end gap-2">
                    ...
                    <button
                      ...
                      className="px-3 py-1.5 text-sm font-medium text-white bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-blue-500"
                    >
                      Save Prompt
                    </button>
                  </div>
          ...
          <div className="flex justify-end gap-3 mt-6">
            ...
            <button
              onClick={handleClose}
              className="px-4 py-2 text-sm font-medium text-white rounded-lg bg-gradient-to-r from-blue-500 to-blue-600 hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
              Close
            </button>
          </div>
